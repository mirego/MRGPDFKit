...
@implementation MRGPDFKitObjectParser
{
    NSString* _str;
}
...
{
    return [[MRGPDFKitObjectParser alloc] initWithString:string];
...
{
    NSString* work = [st stringByTrimmingCharactersInSet:[MRGPDFKitUtility whiteSpaceCharacterSet]];
    ...
    if([work isEqualToString:@"true"]) {
        return [NSNumber numberWithBool:YES];
    }
    if([work isEqualToString:@"false"]) {
    ...
    return [MRGPDFKitObject createWithPDFRepresentation:work];
}
